...
QHexEdit::QHexEdit(QWidget* parent) : QScrollArea(parent), qHexEdit_p(this)
{
...
int QHexEdit::indexOf(const QByteArray& ba, int from)
{
...
int QHexEdit::lastIndexOf(const QByteArray& ba, int from)
{
...
void QHexEdit::setSelection(int begin, int end)
{
    qHexEdit_p.setSelection(begin, end);
}
